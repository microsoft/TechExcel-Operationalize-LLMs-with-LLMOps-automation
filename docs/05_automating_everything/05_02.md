...
We will use an example project bootstrapped in the **YOUR** GitHub repository for example **placerda/rag-project**, based on the [llmops-project-template](https://github.com/azure/llmops-project-template). The same process applies to your bootstrapped project repository. For detailed instructions on bootstrapping a project, refer to the [Bootstrapping a New Project](05-01.md) page. Use a command like the one below to clone your bootstrapped project:
