...
2. Create a GitHub personal access token.
    ...
    4. Choose the repo you just created in the Repository access section.
        ...
        ![The Only select repositories radio button is selected and the new repo is selected in the dropdown list.](media/lab6grab4b.png)
    ...
    5. In the Permissions section, add **Read and write** to the following items: **Administration**, **Contents**, and **Workflows** (Metadata is mandatory).
        ...
        ![The selected permissions are displayed within the overview grid.](media/lab6grab4c.png)
