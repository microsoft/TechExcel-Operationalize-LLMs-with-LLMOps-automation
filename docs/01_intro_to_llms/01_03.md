...
In this task, you will leverage the Azure Content Safety service and test it with a prompt that includes violent content.

## Success Criteria

* Test the Azure Content Safety service with a prompt that includes violent content.
